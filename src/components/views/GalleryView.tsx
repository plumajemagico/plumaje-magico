    ...
    <div className="space-y-10 pb-16">
      ...
      <div className="space-y-3">
        ...
        <p className="text-slate-600 text-sm sm:text-base max-w-3xl leading-relaxed">
          Catálogo fotográfico de referencia para la identificación visual de fenotipos, tonalidades, marcas alares, nidadas y detalles morfológicos.
        </p>
      </div>
          ...
          >
            <div className="relative overflow-hidden aspect-4/3 bg-slate-100">
              ...
              <div className="absolute top-3 right-3">
                <VerificationBadge status={item.verificationStatus} showText={false} />
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 pt-2 text-xs text-slate-300">
                  {activeItem.colorLine && (
                    <div><strong className="text-white">Línea de color:</strong> {activeItem.colorLine}</div>
                  )}
                  {activeItem.mutations.length > 0 && (
                    <div><strong className="text-white">Mutaciones:</strong> {activeItem.mutations.join(', ')}</div>
                  )}
                  {activeItem.credit && (
                    <div><strong className="text-white">Crédito / Aviario:</strong> {activeItem.credit}</div>
                  )}
                </div>

                <div className="pt-2">
                  <VerificationBadge status={activeItem.verificationStatus} />
                </div>
              </div>
