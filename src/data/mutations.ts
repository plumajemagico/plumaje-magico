...
export const MUTATIONS_DATA: MutationItem[] = [
  ...
  },
  {
    ...
    geneticsExplanation: 'Alelo ligado al cromosoma Z que forma parte de la serie alélica del locus Ino (el alelo Clearbody es codominante/alelo intermedio con Ino).',
    carriersExplanation: 'Solo los machos pueden ser portadores no visuales.',
    breedingTips: 'Al cruzar Macho Texas Clearbody con Hembra Ino se producen hembras Clearbody y machos portadores de ino.',
